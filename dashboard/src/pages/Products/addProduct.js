...
import { fetchDataFromApi, postData, deleteImages, deletData } from "../../utils/api";
            ...
            <div className="right-content w-100">
                        ...
                        <div className="col-sm-12" >
                            <div className="card p-4" >
                                ...
                                <div className="row">
                                    ...
                                    <div className="col" >
                                        <div className="form-group">
                                            <h6 className="text-uppercase" >is  Populair</h6>
                                            <Select
                                                value={isPopulairValue}
                                                onChange={handleChangeisPopulairValue}
                                                displayEmpty
                                                inputProps={{ 'aria-label': 'Without label' }}
                                                className="w-100"
                                            >
                                        ...
                                        <div className="form-group">
                                            ...
                                            >
                                                ...
                                                </MenuItem>
                                                {
                                                    ...
                                                    context.brandData?.brandList?.map((cat, index) => {
                                                        return (
                                                            <MenuItem className="text-capitalise"
                                                                value={cat._id} key={index}
                                                                onClick={() => selectBrand(cat.name)}>
                                                                {cat.name}</MenuItem>
                                    ...
                                    <div className="col-md-4" >
                                        <div className="form-group">
                                            ...
                                            >
                                                ...
                                                {/* <MenuItem value={'autres'}>others</MenuItem> */}
                                            </Select>
                ...
                <div className="card p-4 mt-0" >
                    ...
                    <Button type="submit" className="btn-blue btn-lg btn-big w-100"
                        onClick={addProduct}  ><FaCloudUploadAlt />
