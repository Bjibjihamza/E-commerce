...
const EditBrand = () => {
    ...
    const editBrand = (e) => {
        ...
        if (formFields.name !== "" &&  previews.length !== 0) {
            ...
            editData(`/api/brand/${id}`, formFields).then(res => {
                setIsLoading(false);
    ...
    return (
        <>
            <div className="right-content w-100">
                ...
                <form className="form" onSubmit={editBrand}  >
                    <div className="row" >
                        <div className="col-sm-12" >
                            <div className="card p-4" >
                                ...
                                <div className="form-group" >
                                    <h6>Brand Name</h6>
                                    <input type='text' value={formFields.name} name="name" onChange={changeInput} />
                                </div>
                                ...
                                <div className="imagesUploadSec" >
                                    ...
                                    <Button type="submit" className="btn-blue btn-lg btn-big w-100"
                                        onClick={editBrand}  ><FaCloudUploadAlt />
